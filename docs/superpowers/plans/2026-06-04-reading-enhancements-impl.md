...
- [x] **Step 3: 实现 updateReadStatus 并更新 list()**
...
- [x] **Step 3: 实现 ReadService.updateReadStatus**
...
- [x] **Step 3a: 在 scripts.ts 末尾添加 stub（Task 7 会替换为完整实现）**
